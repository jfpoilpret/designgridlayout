...
public class SyncHorizontalFixedHeightRowsConsistentBaselineSpacing 
	extends SyncHorizontalFixedHeightRows
{
	public static void main(String[] args)
	{
		SyncHorizontalFixedHeightRowsConsistentBaselineSpacing example = 
			new SyncHorizontalFixedHeightRowsConsistentBaselineSpacing();
		example.go(true);
	}
