...
public class SyncLayoutVertical2LayoutsWithBorders extends AbstractSyncLayoutExample
{
	public static void main(String[] args)
	{
		SyncLayoutVertical2LayoutsWithBorders example = 
			new SyncLayoutVertical2LayoutsWithBorders();
		example.go(true);
	}
	
	public SyncLayoutVertical2LayoutsWithBorders()
	{
		super(true);
	}
