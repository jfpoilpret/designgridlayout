...
public class SyncVerticalCheckHGaps extends AbstractSyncLayoutExample
{
	public static void main(String[] args)
	{
		SyncVerticalCheckHGaps example = new SyncVerticalCheckHGaps();
		example.go(true);
	}
	
	public SyncVerticalCheckHGaps()
	{
		super(true);
	}
