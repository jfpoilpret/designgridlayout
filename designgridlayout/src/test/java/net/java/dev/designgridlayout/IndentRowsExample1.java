...
public class IndentRowsExample1 extends AbstractBaseExample
{
	...
	{
		IndentRowsExample1 example = new IndentRowsExample1();
		example.go(true);
	}
	...
	@Override public void build(DesignGridLayout layout)
	{
		...
		layout.row().grid(label("Label 2:")).indent().add(field("field2"));
		layout.row().grid(label("Label 3:")).indent().add(field("field3"));
	}
