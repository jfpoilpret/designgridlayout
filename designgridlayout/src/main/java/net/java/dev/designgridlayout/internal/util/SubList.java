...
import net.java.dev.designgridlayout.internal.row.RowItem;
...
public final class SubList extends AbstractList<RowItem> implements RandomAccess
{
	public SubList(List<RowItem> source)
	{
		_source = source;
		_from = source.size();
	}
