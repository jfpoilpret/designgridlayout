...
public final class ComponentHelper
{
	...
	public static int maxValues(Iterable<? extends IRowItem> items, IExtractor extractor)
	{
		int max = 0;
	...
	public static int sumValues(Iterable<? extends IRowItem> items, IExtractor extractor)
	{
		int sum = 0;
		for (IRowItem item: items)
		{
	...
	public static int hgap(List<? extends IRowItem> items, Container parent)
	{
		return hgap(ComponentGapsHelper.instance(), items, parent);
	}
	
	public static int hgap(JComponent first, List<? extends IRowItem> items, Container parent)
	{
	...
	public static boolean isFixedHeight(
