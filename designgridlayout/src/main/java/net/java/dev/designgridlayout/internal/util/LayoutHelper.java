...
{
	public LayoutHelper(HeightGrowPolicy tester, int parentWidth, boolean rtl)
	{
	...
	public void setRowAvailableHeight(int availableHeight)
	{
	...
	public void setHeight(int rowIndex, JComponent component, int spannedRows)
	{
	...
	public int setSizeLocation(JComponent component, int x, int width, 
